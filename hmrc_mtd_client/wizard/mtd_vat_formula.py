...
class MtdCalculationFormula(models.TransientModel):
    ...
    def get_default_params_formula(self, fields):
        ...
        return {
            'box_one': IrConfigParam.get_param('mtd.box_one_formula', 'sum([vat_ST0,vat_ST1,vat_ST2,vat_ST11]) + vat_fuel + vat_bad'),
            ...
            'box_six': IrConfigParam.get_param('mtd.box_six_formula', 'sum([net_ST0,net_ST1,net_ST2,net_ST11]) + sum([net_ST4]) + net_fuel + net_bad'),
